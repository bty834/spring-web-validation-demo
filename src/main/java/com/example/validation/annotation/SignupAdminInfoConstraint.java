...
import com.example.validation.validator.SignupAdminInfoConstraintValidator;
...
@Constraint(validatedBy = SignupAdminInfoConstraintValidator.class)
// 规范强调必须支持FIELD METHOD TYPE ANNOTAION_TYPE,其他的不做要求，是否支持得看具体实现
@Target({ElementType.METHOD,ElementType.TYPE,ElementType.FIELD,ElementType.PARAMETER})
// 必须为RUNTIME
@Retention(RetentionPolicy.RUNTIME)
public @interface SignupAdminInfoConstraint {
    ...
    String message() default "{com.example.validation.annotation.SignupAdminInfoConstraint.message}";
    // 默认必须为空
